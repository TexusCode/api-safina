<div>
    <div class="hlt95 mb-5">
        ...
        <p class="block w4xo0 jy5gh dark:text-neutral-500">
            Введите данные и текст сообщения
        </p>
    </div>
    ...
    <div>
        <form wire:submit="send_message" class="overflow-y-auto space-y-3">
            ...
            <div>
                ...
                <input type="text" required wire:model="phone" id="phone" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm
