<div class="space-y-5">
    ...
    <form wire:submit.prevent="add_order" class="space-y-2">
        ...
        <div class="grid space-y-2 mt-5">
            ...
            <label for="tariff_8" class="flex p-3 w-full bg-white border border-gray-200 rounded-lg text-sm
                focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700
                dark:text-neutral-400">
                <input type="radio" id="tariff_8" name="tariff" wire:model="tariff" value="8" required class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500
                ...
                <span class="text-sm text-gray-500 ms-3 dark:text-neutral-400">8 сомони</span>
            </label>
