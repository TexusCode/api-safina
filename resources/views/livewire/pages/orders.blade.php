<div>
    <div class="w-full gu4ri mx-auto">
        ...
        <ul class="space-y-3">
            <!-- List Item -->
            @for ($i=0;$i<10;$i++) <li class=" u9m3z lnk45 dark:border-neutral-700">
                <div class="flex vyfcq items-center">
                    <span class="text-white font-bold border-neutral-700 border-1 py-1 px-1.5 rounded-lg">#111</span>
                    <div class="hlt95">
