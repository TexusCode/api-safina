<div>
    <div class="grid gap-3 my-4 md:grid-cols-2">
        <div>
            <flux:text class="text-xs uppercase tracking-wide text-neutral-500">По телефону</flux:text>
        ...
        <div>
            <flux:text class="text-xs uppercase tracking-wide text-neutral-500">По номеру заказа</flux:text>
    ...
    <flux:tab.group class="my-5">
        ...
        <flux:tabs variant="segmented" class="w-full" wire:model="tab">
            <flux:tab name="profile" icon="calendar"></flux:tab>
            <flux:tab name="ready" icon="check-badge"></flux:tab>
            <flux:tab name="previous" icon="clock"></flux:tab>
            <flux:tab name="account" icon="archive-box"></flux:tab>
        </flux:tabs>
        ...
        <flux:tab.panel name="ready">
            <div class="w-full gu4ri mx-auto">
                ...
                <flux:table :paginate="$ready">
                </flux:table>
            </div>
        </flux:tab.panel>

        <flux:tab.panel name="previous">
            <div class="w-full gu4ri mx-auto">
                <ul class="space-y-3 mb-5">
                    @foreach ($previousMonth as $order)
                        <li class=" u9m3z lnk45 dark:border-neutral-700">
                            <div class="flex vyfcq items-center">
                                <span
                                    class="text-white font-bold border-neutral-700 border-1 py-1 px-1.5 rounded-lg">#{{ $order->no }}</span>
                ...
                <flux:table :paginate="$previousMonth">
                </flux:table>
            </div>
        </flux:tab.panel>
