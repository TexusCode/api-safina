<div
    class="mt-7 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700 w-full">
    <div class="p-4 sm:p-7">
        <div class="text-center">
            <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Войдите в аккаунт!</h1>
        ...
        <div class="mt-5">
            ...
            <form wire:submit="login">
                <div class="grid gap-y-4">
                    <div class="max-w-sm">
                        <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Номер
                            телефон</label>
                        <input type="number" id="input-label" wire:model="phone" required
                            ...
                            placeholder="005335051">
                    </div>
                    <div class="max-w-sm">
                        <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Пароль</label>
                        <input type="password" id="input-label" wire:model="password" required minlength="6"
                            class="py-2.5 border-2 outline-0 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                    ...
                    <div class="flex">
                        ...
                        <label for="hs-default-checkbox"
                            class="text-sm text-gray-500 ms-3 dark:text-neutral-400">Запомнить меня!</label>
                    </div>
