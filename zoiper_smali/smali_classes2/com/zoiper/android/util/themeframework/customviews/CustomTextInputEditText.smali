.class public Lcom/zoiper/android/util/themeframework/customviews/CustomTextInputEditText;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 29
    invoke-direct {p0, p2}, Lcom/zoiper/android/util/themeframework/customviews/CustomTextInputEditText;->configureTheme(Landroid/util/AttributeSet;)V
...
.method private configureTheme(Landroid/util/AttributeSet;)V
    ...
    .line 57
    invoke-virtual {p0}, Lcom/zoiper/android/util/themeframework/customviews/CustomTextInputEditText;->getContext()Landroid/content/Context;
    ...
    .line 108
    invoke-virtual {p0, v1, v0}, Lcom/zoiper/android/util/themeframework/customviews/CustomTextInputEditText;->setTextSize(IF)V

    :cond_2
    if-eqz v3, :cond_3

    .line 112
    invoke-virtual {p0, v3}, Lcom/zoiper/android/util/themeframework/customviews/CustomTextInputEditText;->setTextColor(I)V

    :cond_3
    if-eqz v4, :cond_4

    .line 116
    invoke-virtual {p0, v4}, Lcom/zoiper/android/util/themeframework/customviews/CustomTextInputEditText;->setBackgroundColor(I)V

    .line 122
    :cond_4
    invoke-virtual {p0}, Lcom/zoiper/android/util/themeframework/customviews/CustomTextInputEditText;->getBackground()Landroid/graphics/drawable/Drawable;
