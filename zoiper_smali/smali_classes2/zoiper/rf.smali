...
.method constructor <init>(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-interface {p1, p0}, Lzoiper/aad;->b(Lzoiper/rf;)V
...
.method public hz()Z
    ...
    .line 29
    invoke-virtual {p0}, Lzoiper/rf;->hO()Ljava/lang/String;
    ...
    .line 33
    :cond_0
    iget-object v1, p0, Lzoiper/rf;->tP:Lzoiper/zz;

    invoke-interface {v1, v0}, Lzoiper/zz;->cd(Ljava/lang/String;)Lretrofit2/Call;

    move-result-object v0

    .line 34
    invoke-virtual {p0, v0}, Lzoiper/rf;->a(Lretrofit2/Call;)Z
