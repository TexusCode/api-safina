.class final Lcom/google/zxing/pdf417/encoder/PDF417;
...
.field public static final PREFERRED_RATIO:F = 3.0f
...
.method private static getNumberOfDataCodewords(III)I
    .locals 0
    ...
    .line 613
    invoke-static {p0, p1, p2}, Lcom/google/zxing/pdf417/encoder/PDF417;->getNumberOfRows(III)I
...
.method private static getNumberOfRows(III)I
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/WriterException;
    ...
    .line 549
    invoke-static {p0, p1, p2}, Lcom/google/zxing/pdf417/encoder/PDF417;->calculateNumberOfRows(III)I
    ...
    const-string p1, "The message is too short for the configured symbol size. The resultant number of rows is less than 3. Please decrease the number of columns or increase the error correction level to increase the number of rows."
    ...
    const-string p1, "The message doesn\'t fit in the configured symbol size. The resultant number of rows for this barcode exceeds 90. Please increase the number of columns or decrease the error correction level to reduce the number of rows."
...
# virtual methods
.method determineDimensions(II)[I
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/WriterException;
...
.method generateBarcodeLogic(Ljava/lang/String;I)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/WriterException;
    ...
    invoke-static {p1, v1}, Lcom/google/zxing/pdf417/encoder/PDF417HighLevelEncoder;->encodeHighLevel(Ljava/lang/String;Lcom/google/zxing/pdf417/encoder/Compaction;)Ljava/lang/String;
    ...
    .line 693
    invoke-virtual {p0, v2, v0}, Lcom/google/zxing/pdf417/encoder/PDF417;->determineDimensions(II)[I
    ...
    .line 719
    new-instance v10, Lcom/google/zxing/pdf417/encoder/BarcodeMatrix;

    invoke-direct {v10, v8, v7}, Lcom/google/zxing/pdf417/encoder/BarcodeMatrix;-><init>(II)V

    iput-object v10, p0, Lcom/google/zxing/pdf417/encoder/PDF417;->barcodeMatrix:Lcom/google/zxing/pdf417/encoder/BarcodeMatrix;
    ...
    const-string v1, "Encoded message contains to many code words, message to big ("
...
.method getBarcodeMatrix()Lcom/google/zxing/pdf417/encoder/BarcodeMatrix;
    .locals 1
...
.method setCompaction(Lcom/google/zxing/pdf417/encoder/Compaction;)V
    .locals 0
