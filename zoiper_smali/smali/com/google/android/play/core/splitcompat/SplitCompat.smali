...
.method public static a(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0}, Lcom/google/android/play/core/splitcompat/SplitCompat;->g(Landroid/content/Context;Z)Z
...
.method static synthetic c(Lcom/google/android/play/core/splitcompat/SplitCompat;)Ljava/util/Set;
    .locals 0

    invoke-direct {p0}, Lcom/google/android/play/core/splitcompat/SplitCompat;->f()Ljava/util/Set;
...
.method static synthetic d(Lcom/google/android/play/core/splitcompat/SplitCompat;)Lcom/google/android/play/core/splitcompat/c;
    .locals 0
...
.method private static g(Landroid/content/Context;Z)Z
    .locals 11

    invoke-static {}, Lcom/google/android/play/core/splitcompat/SplitCompat;->e()Z
    ...
    invoke-static {v0, v3, v2}, Lcom/google/android/gms/common/api/internal/zap$$ExternalSyntheticBackportWithForwarding0;->m(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    new-instance v7, Lcom/google/android/play/core/internal/av;

    iget-object v4, v0, Lcom/google/android/play/core/splitcompat/SplitCompat;->b:Lcom/google/android/play/core/splitcompat/c;

    new-instance v5, Lcom/google/android/play/core/internal/ax;

    invoke-direct {v5}, Lcom/google/android/play/core/internal/ax;-><init>()V

    invoke-direct {v7, p0, v4, v5, v3}, Lcom/google/android/play/core/internal/av;-><init>(Landroid/content/Context;Lcom/google/android/play/core/splitcompat/c;Lcom/google/android/play/core/internal/ax;[B)V
    ...
    invoke-direct/range {v4 .. v9}, Lcom/google/android/play/core/internal/at;-><init>(Landroid/content/Context;Ljava/util/concurrent/Executor;Lcom/google/android/play/core/internal/av;Lcom/google/android/play/core/splitcompat/c;Lcom/google/android/play/core/splitcompat/p;)V
    ...
    invoke-static {v2}, Lcom/google/android/play/core/splitinstall/o;->b(Lcom/google/android/play/core/splitinstall/n;)V
    ...
    :cond_1
    :try_start_0
    invoke-direct {v0, p0, p1}, Lcom/google/android/play/core/splitcompat/SplitCompat;->h(Landroid/content/Context;Z)V
    :try_end_0
...
.method private final declared-synchronized h(Landroid/content/Context;Z)V
    ...
    invoke-virtual {v0}, Lcom/google/android/play/core/splitcompat/c;->i()Ljava/util/Set;
    ...
    invoke-static {v5}, Lcom/google/android/play/core/splitinstall/p;->e(Ljava/lang/String;)Z
    ...
    invoke-static {v4}, Lcom/google/android/play/core/splitinstall/p;->e(Ljava/lang/String;)Z
    ...
    invoke-static {v5}, Lcom/google/android/play/core/splitinstall/p;->d(Ljava/lang/String;)Z
    ...
    invoke-static {}, Lcom/google/android/play/core/internal/ax;->a()Lcom/google/android/play/core/internal/aw;
    ...
    invoke-interface {v1, v3, v0}, Lcom/google/android/play/core/internal/aw;->a(Ljava/lang/ClassLoader;Ljava/util/Set;)V
    ...
    :cond_f
    invoke-interface {v1, v3, v5}, Lcom/google/android/play/core/internal/aw;->a(Ljava/lang/ClassLoader;Ljava/util/Set;)V
    ...
    invoke-interface {v1, v3, v6, v7, p2}, Lcom/google/android/play/core/internal/aw;->b(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/io/File;Z)Z
    ...
    :cond_14
    iget-object p2, p0, Lcom/google/android/play/core/splitcompat/SplitCompat;->d:Lcom/google/android/play/core/splitcompat/a;

    invoke-virtual {p2, p1, v0}, Lcom/google/android/play/core/splitcompat/a;->b(Landroid/content/Context;Ljava/util/Set;)V
...
.method public static installActivity(Landroid/content/Context;)Z
    ...
    invoke-direct {v0}, Lcom/google/android/play/core/splitcompat/SplitCompat;->f()Ljava/util/Set;
